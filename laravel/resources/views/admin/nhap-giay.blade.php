...
@section('page-title', 'Nhập giày mới')
@section('content')
    <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
        <form id="form-shoe" method="POST" action="{{ route('admin.shoes.store') }}" class="space-y-4">
            @csrf
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label for="stud_type" class="block text-sm font-medium text-gray-700">Loại đinh</label>
                    <input type="text" id="stud_type" name="stud_type" class="mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-gray-200" required>
                </div>
                <div>
                    <label for="silo" class="block text-sm font-medium text-gray-700">Silo (dòng giày)</label>
                    <input type="text" id="silo" name="silo" class="mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-gray-200">
                </div>
                <div>
            ...
            <div>
                ...
                <div id="variants-container">
                    <div class="variant-item grid grid-cols-5 gap-4 items-end mt-4">
                        <div><label class="block text-xs font-medium text-gray-500">SKU</label><input type="text" name="variants[0][sku]" class="mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-gray-200" required></div>
                        <div><label class="block text-xs font-medium text-gray-500">Màu</label><input type="text" name="variants[0][color]" class="mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-gray-200" required></div>
                        <div><label class="block text-xs font-medium text-gray-500">Size</label><input type="text" name="variants[0][size]" class="mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-gray-200" required></div>
                        <div><label class="block text-xs font-medium text-gray-500">Tồn kho</label><input type="number" name="variants[0][stock_quantity]" class="mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-gray-200" value="0"></div>
                        <div><label class="block text-xs font-medium text-gray-500">Giá riêng</label><input type="number" name="variants[0][price_override]" class="mt-1 w-full border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-gray-200"></div>
                    </div>
                </div>
